...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(black..'ooo6oo:Channel:Join')}, },}}
...
if text == (Redis:get(black.."black:Name:Bot") or "باندا") then
local NamesBot = (Redis:get(black.."black:Name:Bot") or "باندا")
local NameBots = {
"محمد "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(black.."black:Name:Bot") or "باندا")..
