...
{
{text = 'Source black', url='https://t.me/UU_black'},
},
}
}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/UU_black'}, },}}
...
data = {
{
{text = '- قناة السورس', url = 't.me/UU_black'}, 
},
...
photo = "https://t.me/UU_blackVX/647"
local RinkBot = msg.Name_Controller
...
{{text = '◉ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙉𝘼𝙆  .', url = 't.me/UU_black'}}, 
{{text = 'اضف البوت لمجموعتك', url = 't.me/'..UserBot..'?startgroup=new'}}, 
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/UU_blackVX/646&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/UU_black'}, 
},
{
...
{
{text = '- قناة السورس.', url = 't.me/UU_black'},{text = '- لتنصيب بوتك', url = 'https://t.me/xb8bbot'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url"t.me/UU_black"},
},
}
...
keyboard.inline_keyboard = { 
{{text = '• 𝘿𝙀𝙑  .',url="https://t.me/UU_0P"}},
{{text = '• 𝙎𝙊??𝙍𝘾𝙀 𝙎𝙉𝘼𝙆 .',url="t.me/UU_black"}},
} 
local msg_id = msg.id_/2097152/0.5 
