...
if text == 'المطور' or text == 'مطور' then
local TextingDevJOK = Redis:get(JOK..'JOK:Texting:DevJOK')
if TextingDevJOK then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevJOK,"md",true)  
else
local UserInfo = LuaTele.getUser(Sudo_Id)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
if text == 'جوكر' or text == 'محمد' or text == 'الحوكر' then
photo = "https://t.me//2"
local RinkBot = msg.Name_Controller
local Name = ''
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑♆',url="https://t.me/php_cx"},{text = '𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑♆',url="https://t.me/php_cx"}},
{{text = '◉ BOT  .', url = 't.me/joker'}},
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال الجوكر و بلاك و بسبوسه', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال الجوكر و بلاك و بسبوسه', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال الجوكر و بلاك ', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال الجوكر و بلاك و بسبوسه', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال الجوكر و بلاك', 1, 'md')
end
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '•︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال الجوكر و بلاك ', 1, 'md')
end
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '• 𝘿𝙀𝙑  .',url="https://t.me/php_cx"}},
{{text = '• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊𖤓',url="t.me/BLACK_TEAM_4"}},
} 
