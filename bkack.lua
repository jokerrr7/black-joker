...
{
{text = 'Source black', url='https://t.me/blackTeAm'},
},
}
}
...
--download('https://raw.githubusercontent.com/black-TeAm/black/master/black.lua','black.lua')
...
{{text = '- Source black .',url="t.me/blackTeAm"}},
}
...
{
{text = '❲ تت . ❳', url = "https://t.me/RRRR99"}
},
{
{text = '❲ Dev Source ❳', url = "https://t.me/P222P"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[Source black](t.me/blackTeAm)\n\n[Source Manger](t.me/RRRR99)","md",true, false, false, false,reply_markup)
end
...
data = {
{
{text = '- قناة السورس', url = 't.me/blackTeAm'}, 
},
}
}
